...
- (NSString *)preferredLanguage {
    NSArray *preferredLanguages = [self preferredLocalizations];
    NSArray *supportedLanguages = [self localizations];

    NSString *developerLanguage = [[NSBundle mainBundle] developmentLocalization];
    supportedLanguages = [supportedLanguages count] > 0 ? supportedLanguages : @[developerLanguage ? developerLanguage : @"en"];

    return preferredLanguages.count ? preferredLanguages[0] : supportedLanguages[0];
}
